package com.dicoding.latihanlocalizationpadateks
...
import com.dicoding.latihanlocalizationpadateks.databinding.ActivityMainBinding
import com.dicoding.latihanlocalizationpadateks.withNumberingFormat
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupData(){
        ...
        settupAccessibility(product)
    }

    private fun settupAccessibility(productModel: ProductModel){
        productModel.apply {
            binding.apply {
